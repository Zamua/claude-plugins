...
session lifecycle: a model limit falls back to the next model in the chain
automatically, and a limit past the end of it pauses the route until the
operator selects another provider/model.
